...
trips t r ss = (map (tail . reverse)) $ nub $ paths ++ (concatMap more paths)
    where
        s = map fst ss
...
-- >>> best ts1
-- Ambiguous type variable ‘t0’ arising from a use of ‘minWith’
-- prevents the constraint ‘(Foldable t0)’ from being solved.
-- Relevant bindings include
--   best :: t0 [(a, Integer)] -> [(a, Integer)]
--     (bound at C:\Users\hilov\Desktop\Problem14.hs:106:6)
-- Probable fix: use a type annotation to specify what ‘t0’ should be.
-- These potential instances exist:
--   instance Foldable Graph -- Defined in ‘Distribution.Compat.Graph’
--   instance Foldable Field -- Defined in ‘Distribution.Fields.Field’
--   instance Foldable FieldLine
